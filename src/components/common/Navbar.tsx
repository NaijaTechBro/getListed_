...
//           <Link to="/login" className="border border-black px-3 py-1.5 lg:px-4 lg:py-2 rounded-md hover:bg-gray-100 transition-colors">Login</Link>
//           <Link to="/register" className="bg-black text-white px-3 py-1.5 lg:px-4 lg:py-2 rounded-md hover:bg-gray-800 transition-colors">Register</Link>
//         </div>
